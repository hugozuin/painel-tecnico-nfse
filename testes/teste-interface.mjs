...
botaoLogs.click();
const rotuloUsuario = document.getElementById("usuarioChipLabel");
conferir("sem identificação o botão mostra Identificar-se", rotuloUsuario.textContent === "Identificar-se", rotuloUsuario.textContent);
...
document.getElementById("usuarioChip").click();
document.getElementById("usuarioInput").value = "consultor.teste";
document.getElementById("usuarioOk").click();
conferir("identificação gravada aparece no botão", rotuloUsuario.textContent === "consultor.teste" && document.getElementById("usuarioModal").hidden, rotuloUsuario.textContent);
